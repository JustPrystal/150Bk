                                            ...
                                            <>
                                                ...
                                                <div className="select-wrap">
                                                    ...
                                                    <select class="form-control-input layout" name="layout" required>
                                                        <option id='PH' value="" disabled selected>Studio</option>
                                                ...
                                                <div className="date-wrap">
                                                    ...
                                                    <input class="form-control-input date" onInput={placeholderRemove} onBlur={placeholderRemove} type="date" placeholder="Move-in-Date" name="move_in_date" required />
                                                </div>
                                                <textarea id="message_textarea" onChange={() => { auto_grow() }} name="message" placeholder='Message' rows="2" required />
                                                <button type="submit" class="button submit" id="send">Submit</button>
                                            </>
                                        )
                                }
                            </form>
